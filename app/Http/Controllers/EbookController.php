...
class EbookController extends Controller
{
    ...
    public function rentEbook(Request $request)
    {
        ...
        if ($request->rent_day < 7) {
            $rent_money = $Ebook->hire_price;
        } elseif ($request->rent_day >= 7 && $request->rent_day < 30) {
            $rent_money = $Ebook->hire_price * 7 - $Ebook->hire_price * 7 * 0.07;
        } elseif ($request->rent_day >= 30) {
            $rent_money = $Ebook->hire_price * 30 - $Ebook->hire_price * 30 * 0.3;
        }
        ...
        $hire->total_price = (int) $rent_money;
